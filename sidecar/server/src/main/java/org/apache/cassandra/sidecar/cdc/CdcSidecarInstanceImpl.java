...
/**
 * A simple implementation of the {@link CdcSidecarInstance} interface
 */
public class CdcSidecarInstanceImpl implements CdcSidecarInstance
{
    protected int port;
     ...
     */
    public CdcSidecarInstanceImpl(String hostname, int port)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        CdcSidecarInstanceImpl that = (CdcSidecarInstanceImpl) o;
